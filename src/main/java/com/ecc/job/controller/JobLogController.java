...
/**
 * REST controller exposing a job's execution log, both as a paginated history and as a live event stream.
 *
 * @author Damian Kuras
 * @version 1.0
...
public class JobLogController {
     ...
     * @param jobLogModelAssembler converts a {@link JobLog} to a {@link JobLogModel}
     ...
     * @return {@code 200 OK} with the job's log lines as a HATEOAS page, or {@code 404} if the job doesn't exist
     */
     ...
     *
     * @param jobId the job id
     * @return an {@code SseEmitter} streaming {@code log} events (each carrying a {@link JobLogModel}) followed by a final {@code complete} event,
     *     or {@code 404} if the job doesn't exist
     */
